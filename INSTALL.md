...
php installer.php -v 1.43.2
php installer.php -v 1.43.2 -T
```

On Linux you may need to run installation step using `sudo`:

```
sudo php installer.php -v 1.43.2
```

The last command `php installer.php -v 1.43.2 -T` is to test the new installation.
...
```
php installer.php -v 1.43.2 -o install.log -V
```
